        ...
        <div className="inline-flex flex-col items-start gap-10 px-8 md:px-40">
          <div className="space-y-6">
            ...
            <div className="shadow-lg p-6 bg-white rounded-lg">
              ...
              <p className="text-[rgba(0,0,0,0.85)] text-left font-arial font-bold text-[20px] leading-normal tracking-[1.2px] mt-2">
            ...
            <div className="shadow-lg p-6 bg-white rounded-lg">
              ...
              <p className="text-[rgba(0,0,0,0.85)] text-left font-arial font-bold text-[20px] leading-normal tracking-[1.2px] mt-5">
                Thank you for being a part of our story.
              </p>
              <p className="text-[rgba(0,0,0,0.85)] text-left font-arial font-bold text-[20px] leading-normal tracking-[1.2px] mt-5">
                Warm regards,
              </p>
              <p className="text-[rgba(0,0,0,0.85)] text-left font-arial font-bold text-[20px] leading-normal tracking-[1.2px]">
                Ajitbhai Gadhavi,
              </p>
              <p className="text-[rgba(0,0,0,0.85)] text-left font-arial font-bold text-[20px] leading-normal tracking-[1.2px]">
